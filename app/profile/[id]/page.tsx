    ...
    <div className="min-h-screen bg-bg text-text flex flex-col">
      ...
      <main className="flex-grow bg-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-accent hover:text-accent transition-colors group text-sm sm:text-base font-medium"
          >
        ...
        <section className="py-12 bg-gradient-to-br from-bg via-primary/10 to-bg border-b border-accent/10 text-center sm:text-left">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
              <div className="w-24 h-24 sm:w-28 sm:h-28 bg-accent/20 border border-accent rounded-full flex items-center justify-center text-accent shadow-lg">
                {profile.avatar_url ? (
                  <img 
              ...
              <div className="space-y-2 flex-grow">
                <div className="flex items-center justify-center sm:justify-start gap-3 flex-wrap">
                  <span className="px-2.5 py-0.5 bg-accent/20 text-accent font-mono text-xs rounded uppercase tracking-wider">
                    {profile.role}
                  </span>
                  {isOwner && (
                    <ProfileEditModal 
                  ...
                  {profile.orcid ? (
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      {isOwner && (
                        <details className="group relative">
                          ...
                          <div className="absolute left-0 mt-2 p-3 bg-bg border border-red-500/30 rounded-lg text-xs space-y-2 w-64 shadow-2xl z-50 text-left">
                    ...
                    isOwner && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-4 py-1.5 bg-accent/25 hover:bg-accent/45 border border-accent text-accent hover:text-white rounded-full text-xs font-bold transition-all shadow-md"
                      >
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-text-secondary items-center justify-center sm:justify-start">
                  ...
                  {profile.ror_id && (
                    <div className="flex items-center gap-1.5">
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="text-xs text-text-secondary hover:underline font-mono"
                      >
        ...
        <section className="py-12 bg-surface text-text flex-grow">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              
              <div className="lg:col-span-1 space-y-6">
                <div className="bg-bg-alt rounded-lg p-6 shadow-sm border border-border">
                  <h3 className="text-primary font-serif text-lg font-bold mb-3 border-b border-primary/10 pb-2">
                    Biography
                  </h3>
                ...
                <div className="bg-bg-alt rounded-lg p-6 shadow-sm border border-border text-sm space-y-3 text-text-secondary">
                  {profile.affiliation && (
              ...
              <div className="lg:col-span-2 space-y-6">
                <h2 className="text-2xl font-serif text-primary font-bold border-b border-primary/10 pb-2 mb-4">
                ...
                {publications.length > 0 ? (
                  <div className="space-y-6">
                    {publications.map((pub) => (
                      <div 
                        key={pub.id}
                        className="bg-bg-alt p-6 rounded-lg shadow-sm border border-border"
                      >
                        <span className="text-xs text-primary font-mono tracking-wide font-semibold uppercase">
                          Published In: {pub.journalName}
                        </span>
                        
                        <h3 className="text-lg font-serif text-text font-semibold mt-1 mb-2 hover:text-primary transition-colors duration-150">
                        ...
                        <div className="flex items-center justify-between text-xs text-text-secondary/70 pt-3 border-t border-border">
                  ...
                  <div className="bg-bg-alt p-8 rounded-lg shadow-sm border border-border text-center">
                    <BookOpen className="w-10 h-10 text-text-secondary/30 mx-auto mb-3" />
                    <h3 className="text-sm font-bold text-text-secondary">No publications yet</h3>
                    <p className="text-xs text-text-secondary/50 mt-1">Publications will appear here once articles are published.</p>
                  </div>
                )}
              </div>
