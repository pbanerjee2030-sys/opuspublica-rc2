                  ...
                  <div className="prose prose-lg max-w-none prose-headings:text-[#8B1A1A] prose-headings:font-serif prose-a:text-[#C9A84C] prose-a:no-underline hover:prose-a:underline">
                    ...
                    <div id="handled" className="mb-12 scroll-mt-24">
                      ...
                      <div className="space-y-4 text-[#1A1A2E]/80 leading-relaxed text-base">
                        ...
                        <p className="pl-4 border-l-2 border-[#C9A84C]/30 font-semibold">
                          When a concern is raised:
                        </p>
                        <ol className="list-decimal space-y-3 pl-8 border-l-2 border-[#C9A84C]/30 m-0">
                          <li className="pl-2">
                          ...
                          <li className="pl-2">
                            ...
                            of concern, or a retraction, in line with our <Link href="/policies/corrections-and-retractions" className="text-[#C9A84C] font-semibold hover:underline">Corrections, Retractions &amp; Updates Policy</Link>
                          </li>
                          <li className="pl-2">
                        ...
                        <p className="pl-4 border-l-2 border-[#C9A84C]/30 pt-2">
                    ...
                    <div id="reporting" className="mb-12 scroll-mt-24">
                      ...
                      <div className="space-y-4 text-[#1A1A2E]/80 leading-relaxed text-base">
                        <p className="pl-4 border-l-2 border-[#C9A84C]/30">
                          ...
                          the relevant journal's editorial team, or write to us directly at <a href="mailto:editorial@opuspublica.com" className="text-[#C9A84C] font-semibold hover:underline">editorial@opuspublica.com</a>.
                        </p>
                        <p className="pl-4 border-l-2 border-[#C9A84C]/30 italic text-sm text-[#1A1A2E]/60 pt-4">
                          This policy works alongside our <Link href="/policies/corrections-and-retractions" className="text-[#C9A84C] font-semibold hover:underline">Corrections, Retractions &amp; Updates Policy</Link>, our Peer
